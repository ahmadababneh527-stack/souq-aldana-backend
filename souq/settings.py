...
CSRF_TRUSTED_ORIGINS = ['https://*.onrender.space']
...
# ======================================================================
# ✨▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼✨
# ✨ أضف هذا الجزء هنا لحل مشكلة تسجيل الدخول على الهاتف ✨
# ======================================================================
# This will activate these secure settings only when deployed on Render (not locally)
if not DEBUG:
