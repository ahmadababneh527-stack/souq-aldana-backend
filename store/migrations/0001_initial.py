# Generated by Django 5.2.6 on 2025-10-12 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'ذكر'), ('F', 'أنثى')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_number', models.CharField(blank=True, max_length=20, null=True, verbose_name='رقم البطاقة')),
                ('expiry_date', models.CharField(blank=True, max_length=7, null=True, verbose_name='تاريخ الانتهاء')),
                ('cvv', models.CharField(blank=True, max_length=4, null=True, verbose_name='CVV')),
                ('confirmation_code', models.CharField(blank=True, max_length=6, null=True, verbose_name='رمز التأكيد')),
